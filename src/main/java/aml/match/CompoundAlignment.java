...
public class CompoundAlignment implements Iterable<CompoundMapping>
{
	 ...
	 * @param targetId1: the index of the target class to add to the alignment
	 ...
	 * @param targetId1: the index of the target class to check in the alignment
	 ...
	 */
	public String evaluate(CompoundAlignment ref)
	{
		int found = size();		
		int correct = 0;
		int total = 0;
	 ...
	 * @param targetId1: the index of the target class
	 ...
	 * @param targetId1: the index of the target class in the alignment
	...
	/**
	 * @param targetId2: the index of the target class to check in the alignment
	 * @return the list of all source classes mapped to the target class
	 */
	 ...
	 * @param targetId1: the target class to remove from the Alignment
	 */
