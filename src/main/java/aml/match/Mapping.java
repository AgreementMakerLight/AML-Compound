...
//Constructors
	...
	public Mapping(int sId, int tId)
	{
		...
		submaps = new ArrayList<SubMapping>();
	}
	...
	public Mapping(int sId, int tId, double sim, MappingRelation r, List<SubMapping> s)
	{
		sourceId = sId;
		targetId = tId;
		similarity = Math.round(sim*10000)/10000.0;
...
//Public Methods
	...
	public void addSubMapping(SubMapping sm)
	{
		submaps.add(sm);
	}
	
	public void setSubMap(List<SubMapping> m)
	{
		submaps = m;
	}
